...
- The playbook is ELK-install.yml copied to /etc/ansible/roles/ELK-install.yml
- Update /etc/ansible/hosts with a [elk] and [webserver] header for each machine type.
- Check ELK is running with http://ELK_IP_ADDRESS:5601/app/kibana
